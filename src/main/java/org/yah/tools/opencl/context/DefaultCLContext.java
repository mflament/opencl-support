...
public class DefaultCLContext implements CLContext {
    ...
    public DefaultCLContext(long platform,
            ContextPropertiesMap properties, ErrorHandler errorHandler,
            long... deviceIds) {
    ...
    private static DefaultCLContext create(long platformId, ErrorHandler errorHandler,
            long... deviceIds) {
        ContextPropertiesMap props = new ContextPropertiesMap();
        props.put(ContextProperties.CONTEXT_PLATFORM, platformId);
        return new DefaultCLContext(platformId, props, errorHandler, deviceIds);
    }
    ...
    public static DefaultCLContext createDefault(ErrorHandler errorHandler) {
